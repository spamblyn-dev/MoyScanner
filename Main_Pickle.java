...
public class Main_Pickle {
    public static void main(String[] args) {
        ...
        DeviceDatabase_Pickle.isKnownDevice(null);
        ...
        while (running) {
            ...
            switch (choice) {
                case "1": menuHandler.localSubnetMenu(); break;
                case "2": menuHandler.wholeNetworkMenu(); break;
                case "3":
                    System.out.print("Enter IP to ping: ");
                    String ip = sc.nextLine();
                    System.out.println(ip + (ScannerUtils_Pickle.pingDevice(ip) ? " is reachable." : " is not reachable."));
                    break;
                case "4":
                    ...
                    break;
                case "5": SafeMode_Pickle.runSafeMode(); break;
                case "6": running = false; System.out.println("Exiting program... Goodbye!"); break;
